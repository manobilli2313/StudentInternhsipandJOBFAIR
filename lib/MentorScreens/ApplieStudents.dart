...
class AppliedStudents extends StatefulWidget {
  const AppliedStudents({super.key});

  @override
  State<AppliedStudents> createState() => _AppliedStudentsState();
}

class _AppliedStudentsState extends State<AppliedStudents> {
  ...
  try {
    var response = await MemberApi.getappliedstudent();
  ...
  void blockStudent(int sid) async {
    bool response = await MemberApi.deactivatestudent(sid);
    if (response) {
      setState(() {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Student deactivated successfully!',), backgroundColor: Colors.green,),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to deactivate student. Try again!',), backgroundColor: Colors.red,),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: MentorDrawer(),
      appBar: AppBar(title: const Text('Applied Students')),
      body: Padding(
                                      ...
                                      showDialog(
                                        ...
                                        builder: (BuildContext context) {
                                          return AlertDialog(
                                            ...
                                            content: Text('Are you sure you want to deactivate this student?'),
                                            actions: [
                                              TextButton(
                                                onPressed: () {
