...
class GroupPostersPage extends StatefulWidget {
  @override
  _GroupPostersPageState createState() => _GroupPostersPageState();
}

class _GroupPostersPageState extends State<GroupPostersPage> {
