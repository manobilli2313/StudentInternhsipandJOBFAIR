...
class ActiveEventsforfeedback extends StatefulWidget {
  const ActiveEventsforfeedback({super.key});

  @override
  State<ActiveEventsforfeedback> createState() => _ActiveEventsforfeedbackState();
}

class _ActiveEventsforfeedbackState extends State<ActiveEventsforfeedback> {
  @override
  void initState(){
    super.initState();
    getactiveevent();
                                      ...
                                      child: ElevatedButton(onPressed: (){
                                        setState(() {
                                          Navigator.push(context, MaterialPageRoute(builder:(context){
                                            return EventFeedback(jid:list.id!,);
                                          }));
