...
// import 'package:student_internship_and_jobfair_fyp/CompanyScreens/PastInterview.dart';
// import 'package:student_internship_and_jobfair_fyp/CompanyScreens/Upcoming.dart';
...
//                                  schedule[currentIndex].status==null||schedule[currentIndex].status==""?Text(''):
//                                  Row(
//                                   mainAxisAlignment: MainAxisAlignment.end,
//                                    children: [
//                                      Text('${schedule[currentIndex].status}',style:TextStyle(color: Colors.black,fontSize: 24,fontWeight: FontWeight.bold),),
...
//                 return UpcomingInterview(sid: schedule[currentIndex].studentID,sname: schedule[currentIndex].StudentName,);
//               }));
...
//                                         });
//                                                     Navigator.push(context, MaterialPageRoute(builder:(context){
// //                 return PastInterview(sid: schedule[currentIndex].studentID,sname: schedule[currentIndex].StudentName,);
// //               }));
                              ...
                              children: [
                                ...
                                Row(
                                 ...
                                 const SizedBox(height: 5),
                                  ...
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text('Isfavourite', style: Appconstant.appcardstyle),
                                    Text(data.status==null?'---':data.status!, style: Appconstant.appcardstyle),
                                    ...
                                    height: 40,
                                      child: ElevatedButton(onPressed: (){
                                        setState(() {
                                                    ...
                                                    Navigator.push(context, MaterialPageRoute(builder:(context){
                return PastInterview(sid: data.studentID,sname: data.StudentName,);
              }));
                                  ...
                                  Container(
                                    ...
                                    height: 40,
                                      child: ElevatedButton(onPressed: (){
                                        ...
                                        Navigator.push(context, MaterialPageRoute(builder:(context){
                return UpcomingInterview(sid: data.studentID,sname: data.StudentName,);
              }));
